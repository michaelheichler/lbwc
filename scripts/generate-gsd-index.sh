...
# Output: .lbwc-planning/archive/INDEX.json
# Performance target: <5 seconds for typical projects

set -euo pipefail

# Check if archive exists
ARCHIVE_DIR=".lbwc-planning/archive"
...
jq -n \
  ...
  '{
    ...
    "lbwc_version": $lbwc_version,
    "phases_total": $phases_total,
    "phases_complete": $phases_complete,
    "milestones": $milestones,
    "quick_paths": {
      "roadmap": "archive/ROADMAP.md",
      "project": "archive/PROJECT.md",
