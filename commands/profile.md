...
Follow @${CLAUDE_PLUGIN_ROOT}/references/lbwc-brand-essentials.md , single-line box, ✓ success, ⚠ errors, ➜ transitions, no ANSI.

## Next Up

After validation, show `/lbwc:profile` to review the active profile and stop.
