...
Repo-wide rule for all LSP-capable agents (Scout, Architect, Lead, the engineer roles, QA Author, QA, Debugger, Docs).
...
### coding-dijkstra / python-engineer / web-engineer / test-dev / qa-author / qa / debugger
